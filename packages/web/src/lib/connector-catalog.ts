...
export const CONNECTOR_CATALOG: ConnectorCatalogEntry[] = [
  ...
  { type: 'google_workspace', label: 'Google Workspace', category: 'Productivity', defaultAuthMode: 'oauth_user' },
  { type: 'google_cloud', label: 'Google Cloud', category: 'Cloud', defaultAuthMode: 'oauth_user' },
  { type: 'microsoft365', label: 'Microsoft 365', category: 'Productivity', defaultAuthMode: 'oauth_user' },
